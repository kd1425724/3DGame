...
void Ground::Init()
{
	...
	// 【2026/07/20】影の確認用に、通り1本だけの小さな街へ差し替えた際のサイズ。
	// 街の範囲 X -11.8〜10.0(幅21.8m=影エリア25に収まる) / Z -20.0〜40.3・21棟。
	// 建物の大きさ自体は従来サイズ(gen_town2.py の SCALE=1.0・高さ約14.6m)。
	// 大規模な街に戻す時は 332 x 297 へ(SCALE=2.0・133棟の設定)
	SetScale(Math::Vector3(40.0f, 1.2f, 97.0f));
